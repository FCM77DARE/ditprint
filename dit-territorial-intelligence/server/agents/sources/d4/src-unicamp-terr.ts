...
export class SrcUnicampTerr extends BaseSourceAgent {
  readonly id = "src-unicamp-terr";
  readonly dimension = "D4";
  readonly name = "Observatório de Conflitos de Terra";
    ...
    const searchString = enrichGeoQuery(`site:unicamp.br`, territory);
