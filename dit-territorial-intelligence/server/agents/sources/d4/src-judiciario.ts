...
export class SrcJudiciario extends BaseSourceAgent {
  readonly id = "src-judiciario";
  readonly dimension = "D4";
  readonly name = "Tribunais de Justiça (Atividade Judiciária)";
    ...
    const searchString = enrichGeoQuery(`site:cnj.jus.br OR site:tjba.jus.br`, territory);
