 ...
 * encerra a conversa.
 */
export class SrcSinir extends BaseSourceAgent {
  readonly id = "src-sinir";
  readonly dimension = "D3";
  readonly name = "Busca aberta — resíduos sólidos (SINIR)";
  ...
  protected async fetchSignals(
    ...
    const searchString = enrichGeoQuery(`site:sinir.gov.br OR site:gov.br/mma`, territory);
