 ...
 * encerra a conversa.
 */
export class SrcSnisSinasa extends BaseSourceAgent {
  readonly id = "src-snis-sinasa";
  readonly dimension = "D3";
  readonly name = "Busca aberta — saneamento básico (SNIS)";
  ...
  protected async fetchSignals(
    ...
    const searchString = enrichGeoQuery(`site:snis.gov.br OR site:gov.br/cidades`, territory);
